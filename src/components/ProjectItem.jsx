    ...
    return (
        <div>
            <div className='relative flex items-center  justify-center h-auto w-full shadow-xl rounded-xl p-4 group  '>
                <img className='rounded-xl group-hover:opacity-30 hover:bg-[#73b5e3] transition ease-in duration-200' src={backgroundImg} />
                <div className='hidden group-hover:block absolute top-[50%] left-[50%]  translate-x-[-50%] translate-y-[-50%] transition '>
                    ...
                    <Link to={projectURL}>
                        <div className='w-[100%] flex items-center pl-10 pt-6 md:pl-6 cursor-pointer relative'>
