                ...
                <div className='max-w-[700px] w-full h-screen mx-auto p-10 sm:p-0 flex justify-center items-center  '>
                    <div data-aos='fade-up' >
                        ...
                        <p className='py-4 text-[#eaebf3] max-w-[80%] '>
                            I have found my way back to programming after some years studying economics and working with design and photography. I am mostly using Javascript and React JS.
                        </p>
